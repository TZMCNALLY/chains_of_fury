 ...
 */
export default abstract class AssistState extends State {

    protected parent: AssistController;
	protected owner: COFAnimatedSprite;

	public constructor(parent: AssistController, owner: COFAnimatedSprite){
		super(parent);
		this.owner = owner;
	}
