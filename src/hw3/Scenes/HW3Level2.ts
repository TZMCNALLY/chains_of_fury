...
export default class Level2 extends HW3Level {
    ...
    public static readonly PLAYER_SPAWN = new Vec2(32, 50);
    public static readonly PLAYER_SPRITE_KEY = "PLAYER_SPRITE_KEY";
    public static readonly PLAYER_SPRITE_PATH = "hw4_assets/spritesheets/spike.json";
    ...
    public static readonly LEVEL_MUSIC_PATH = "hw4_assets/music/hw5_level2_music.wav";
