 ...
 */
export default abstract class DemonKingState extends State {

    protected parent: DemonKingController;
	protected owner: COFAnimatedSprite;

	public constructor(parent: DemonKingController, owner: COFAnimatedSprite){
		super(parent);
		this.owner = owner;
	}
